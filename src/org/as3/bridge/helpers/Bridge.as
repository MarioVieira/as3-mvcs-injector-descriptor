package org.as3.bridge.helpers
{
	...
	{
		private var _cairngormCommandHandler	: ControlCommandHandler;
		 ...
		 */
		public function get cairngormCommandHandler():ControlCommandHandler
		{
		...
		{	
			...
			{
				_cairngormCommandHandler = new ControlCommandHandler();
			}
		}
