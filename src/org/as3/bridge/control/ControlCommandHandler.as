package org.as3.bridge.control
{
	...
	/**
	 *
	 * This class allows Inversion of Control and Dependency Injection for migrating from Cairgorm.
	 * 
	 * It receives the commands mapped from the CairgormEvents, and provide a the static reference for subscribers to act upon the commands that concerns their logic
	 * 
	 * In addition it provides a single reference of the application Injector to be allow migrating data from Cairgorm ModelLocators to it.
	 *    
	 */	
	public class ControlCommandHandler extends Signal implements ICairngormToDIIoC
	{
		/** @private **/
		protected var _commandQueue				: ControlCommandQueue;
		...
		public function ControlCommandHandler()
		{
			...
			_commandQueue = new ControlCommandQueue();
		}
